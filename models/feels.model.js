...
exports.selectFeels = () => {
    const queryStr = "SELECT week_number, week_start_date, week_end_date, knowledge, experience, passion, enthusiasm, confidence, wisdom, despair, input, output FROM feels ORDER BY week_start_date ASC;";
    return db.query(queryStr).then(({ rows }) => {
        return rows;
    });
};

exports.updateFeelsForWeek = (update, week_number) => {
    ...
    const queryStr =
        "UPDATE feels SET knowledge = $1, experience = $2, passion = $3, enthusiasm = $4, confidence = $5, wisdom = $6, despair = $7, input = $8, output = $9  WHERE week_number = $10 RETURNING *;";
